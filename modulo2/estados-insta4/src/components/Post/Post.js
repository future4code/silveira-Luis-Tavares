...
import iconeMarcadorPreto from '../../img/marcador-preto.svg'
import iconeMarcadorBranco from '../../img/marcador-branco.svg'
...
class Post extends React.Component {
  ...
  onClickMarcador = () => {
    this.setState({marcador: !this.state.marcador})
  }
